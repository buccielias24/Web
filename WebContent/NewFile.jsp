...
<main role="main">
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="200" height="200" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><title>Planetas</title><rect width="100%" height="100%" fill="#"></rect><image xlink:href="img/login.jpg" width=150% height=100%>></svg>
        <h2>Planetas</h2>
        <p>Aqui podra gestionar los planetas de la galaxia</p>
        <p><a class="btn btn-secondary" href="lista.jsp" role="button">Acceder</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
